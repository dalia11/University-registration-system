...
public class AddProfessor extends javax.swing.JDialog {
     ...
     */
    public AddProfessor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Professor p = new Professor(name, salary, d);
        Admin.p.add(p);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddProfessor dialog = new AddProfessor(new javax.swing.JFrame(), true);
